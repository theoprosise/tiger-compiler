000\008\000\008\000\
\\008\000\008\000\008\000\008\000\
\\008\000\008\000\008\000\008\000\
\\008\000\041\000\039\000\033\000\
\\031\000\025\000\064\000\008\000\
\\018\000\035\000\029\000\053\000\
\\070\000\030\000\006\000\005\000\
\\004\000\003\000\002\000\001\000\
\\052\000\051\000\050\000\049\000\
\\076\000\075\000\074\000\073\000\
\\012\000\014\000\015\000\008\000\
\\008\000\008\000\008\000\055\000\
\\008\000\019\000\066\000\056\000\
\\016\000\008\000\042\000\071\000\
\\036\000\088\000\022\000\027\000\
\\026\000\032\000\060\000\058\000\
\\065\000\054\000\008\000\037\000\
\\068\000\008\000\013\000\008\000\
\\012\000\017\000\063\000\008\000\
\\008\000\067\000\008\000\057\000\
\\077\000\078\000\043\000\017\000\
\\084\000\040\000\081\000\020\000\
\\023\000\034\000\059\000\069\000\
\\012\000\021\000\008\000\024\000\
\\017\000\012\000\008\000\080\000\
\\079\000\085\000\008\000\012\000\
\\082\000\083\000\061\000\086\000\
\\038\000\008\000\087\000\000\000"
val gotoT =
"\
\\001\000\127\000\002\000\003\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\002\000\031\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\032\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\034\000\003\000\002\000\005\000\033\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\007\000\036\000\000\000\
\\002\000\038\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\039\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\002\000\041\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\042\000\003\000\002\000\006\000\001\000\000\000\
...
\\009\000\055\000\010\000\054\000\011\000\053\000\012\000\052\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\002\000\066\000\003\000\002\000\004\000\065\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\034\000\003\000\002\000\005\000\076\000\006\000\001\000\000\000\
\\002\000\077\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\078\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\079\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\002\000\080\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\002\000\084\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\093\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\\002\000\095\000\003\000\002\000\006\000\001\000\000\000\
\\006\000\097\000\013\000\096\000\000\000\
\\002\000\100\000\003\000\002\000\006\000\001\000\000\000\
\\006\000\101\000\000\000\
\\014\000\103\000\015\000\102\000\000\000\
\\000\000\
\\002\000\105\000\003\000\002\000\006\000\001\000\000\000\
\\002\000\106\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\014\000\109\000\015\000\102\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\002\000\117\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\123\000\003\000\002\000\006\000\001\000\000\000\
...
\\000\000\
\\000\000\
\\002\000\126\000\003\000\002\000\006\000\001\000\000\000\
\\000\000\
\\000\000\
\"
val numstates = 128
...
fieldList1, _, _)) :: _ :: ( _, ( MlyValue.typeID typeID1, typeID1left
, _)) :: rest671)) => let val  result = MlyValue.expr (fn _ => let
 val  (typeID as typeID1) = typeID1 ()
 val  (fieldList as fieldList1) = fieldList1 ()
 in (
let val (t,tp) = typeID 
  in A.RecordExp{typ=t, fields=fieldList, pos=tp} 
  end
)
end)
 in ( LrTable.NT 1, ( result, typeID1left, RBRACE1right), rest671)
end
|  ( 19, ( ( _, ( MlyValue.expr expr2, _, expr2right)) :: _ :: _ :: (
 _, ( MlyValue.expr expr1, _, _)) :: _ :: ( _, ( MlyValue.typeID 
typeID1, typeID1left, _)) :: rest671)) => let val  result = 
MlyValue.expr (fn _ => let val  (typeID as typeID1) = typeID1 ()
 val  expr1 = expr1 ()
 val  expr2 = expr2 ()
 in (
let val (t,tp) = typeID
  in A.ArrayExp{typ=t, size=expr1, init=expr2, pos=tp}
  end
)
end)
 in ( LrTable.NT 1, ( result, typeID1left, expr2right), rest671)
end
...
fieldList1 ()
 ...
 in ( LrTable.NT 6, ( result, fieldList1left, expr1right), rest671)
...
result = MlyValue.declarationList (fn _ => let val  (declarationList
 ...
 in ( LrTable.NT 7, ( result, declarationList1left, declaration1right)
, rest671)
end
...
typeDeclaration1) = typeDeclaration1 ()
 ...
 in ( LrTable.NT 8, ( result, typeDeclaration1left, 
...
variableDeclaration as variableDeclaration1) = variableDeclaration1 ()
 ...
 in ( LrTable.NT 8, ( result, variableDeclaration1left, 
...
functionDeclaration as functionDeclaration1) = functionDeclaration1 ()
 ...
 in ( LrTable.NT 8, ( result, functionDeclaration1left, 
functionDeclaration1right), rest671)
end
|  ( 40, ( ( _, ( MlyValue.ty ty1, _, ty1right)) :: _ :: ( _, ( 
MlyValue.typeID typeID1, _, _)) :: ( _, ( _, (TYPEleft as TYPE1left),
 _)) :: rest671)) => let val  result = MlyValue.typeDeclaration (fn _
 => let val  (typeID as typeID1) = typeID1 ()
 val  (ty as ty1) = ty1 ()
 in (
let val (n,np) = typeID
  in A.TypeDec[{name=n, ty=ty, pos=TYPEleft}]
  end
)
end)
 in ( LrTable.NT 9, ( result, TYPE1left, ty1right), rest671)
end
|  ( 41, ( ( _, ( MlyValue.typeID typeID1, typeID1left, typeID1right))
 :: rest671)) => let val  result = MlyValue.ty (fn _ => let val  (
typeID as typeID1) = typeID1 ()
 in (let val (t,tp) = typeID in A.NameTy(t,tp) end)
end)
 in ( LrTable.NT 12, ( result, typeID1left, typeID1right), rest671)
...
|  ( 43, ( ( _, ( MlyValue.typeID typeID1, _, typeID1right)) :: _ :: (
 _, ( _, ARRAY1left, _)) :: rest671)) => let val  result = MlyValue.ty
 (fn _ => let val  (typeID as typeID1) = typeID1 ()
 in (let val (t,tp) = typeID in A.ArrayTy(t,tp) end)
end)
 in ( LrTable.NT 12, ( result, ARRAY1left, typeID1right), rest671)
end
...
|  ( 46, ( ( _, ( MlyValue.typeID typeID1, _, typeID1right)) :: _ :: (
 ...
 val  result = MlyValue.typeField (fn _ => let val  (ID as ID1) = ID1
 ()
 val  (typeID as typeID1) = typeID1 ()
 in (
let val (t,tp) = typeID
  in {name=symMod ID, escape=ref true, typ=t, pos=IDleft}
  end
)
end)
 in ( LrTable.NT 14, ( result, ID1left, typeID1right), rest671)
end
...
A.VarDec{name=symMod ID, escape=ref false, typ=NONE, init=expr, pos=VARleft}
 ...
 in ( LrTable.NT 10, ( result, VAR1left, expr1right), rest671)
end
|  ( 48, ( ( _, ( MlyValue.expr expr1, _, expr1right)) :: _ :: ( _, ( 
MlyValue.typeID typeID1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1, _, _))
...
ID1 ()
 ...
 in (
let val (t,tp) = typeID
  in A.VarDec{name=symMod ID, escape=ref false, typ=SOME(t,tp), init=expr, pos=VARleft}
  end
)
end)
 in ( LrTable.NT 10, ( result, VAR1left, expr1right), rest671)
...
A.FunctionDec[{name=symMod ID, params=typeFields, result=NONE, body=expr, pos=FUNCTIONleft} ]
 ...
 in ( LrTable.NT 11, ( result, FUNCTION1left, expr1right), rest671)

end
|  ( 50, ( ( _, ( MlyValue.expr expr1, _, expr1right)) :: _ :: ( _, ( 
MlyValue.typeID typeID1, _, _)) :: _ :: _ :: ( _, ( 
MlyValue.typeFields typeFields1, _, _)) :: _ :: ( _, ( MlyValue.ID ID1
, _, _)) :: ( _, ( _, (FUNCTIONleft as FUNCTION1left), _)) :: rest671)
 ...
 val  (expr as expr1) = expr1 ()
 in (
let val (rt,rp) = typeID
  in A.FunctionDec[{name=symMod ID, params=typeFields, result=SOME(rt,rp), body=expr, pos=FUNCTIONleft}]
  end
)
end)
 in ( LrTable.NT 11, ( result, FUNCTION1left, expr1right), rest671)
...
rest671)) => let val  result = MlyValue.typeID (fn _ => let val  (ID
 as ID1) = ID1 ()
 in ((symMod ID, IDleft))
end)
