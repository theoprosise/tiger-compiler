...
val expectedOutputs : (string * string) list = [
  ...
  ("test20.tig", "Error: undeclared variable i"),
  ("test21.tig", "Error : procedure returns value and procedure is used in arexpr"),
  ("test22.tig", "Error : field not in record type"),
