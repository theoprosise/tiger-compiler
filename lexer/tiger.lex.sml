...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN COMMENT; commentCount := 1; continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentCount := !commentCount + 1; continue()))
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentCount := !commentCount -1; if !commentCount = 0 then YYBEGIN INITIAL else (); continue()))
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN STRING; curString := ""; stringStart := yypos; continue()))
fun yyAction7 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (stringAdd yytext; continue())
      end
...
fun yyAction11 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringAdd "\t"; YYBEGIN STRING; continue()))
...
fun yyAction14 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (stringAdd (String.str (String.sub(yytext, 1))); YYBEGIN STRING; continue())
      end
fun yyAction15 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm;
        (stringAdd (String.str (Char.chr (valOf (Int.fromString yytext)))); YYBEGIN STRING; continue())
      end
...
fun yyAction17 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Illegal Escape \\" ^ yytext); YYBEGIN STRING; continue())
      end
fun yyAction18 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos "Newline in string literal"; YYBEGIN INITIAL; continue()))
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!curString, !stringStart, yypos+1)))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ76(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction30(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction30(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction30, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction31(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ71(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ110(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ109(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction36(strm, yyNO_MATCH)
                      else yyQ71(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction36(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction36, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ113(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ71(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
              else yyAction61(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ112(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
       ...
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ116(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
...
fun yyQ48 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ118(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
...
fun yyQ119 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ119(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction46(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ120(strm', yyMATCH(strm, yyAction46, yyNO_MATCH))
       ...
       of NONE => yyAction7(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyAction7(strm, yyNO_MATCH)
                  else yyQ9(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction7(strm, yyNO_MATCH)
              else yyQ9(strm', yyMATCH(strm, yyAction7, yyNO_MATCH))
      (* end case *))
